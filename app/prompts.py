...
# должны быть обычным текстом (не JSON). Не используй Markdown-форматирование (жирный, курсив, кодовые блоки) — отвечай простым текстом. Он умеет анализировать переписки,
